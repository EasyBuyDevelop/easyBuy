...
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			<h1>欢迎回到易买网</h1>
			<form id="loginForm" method="post" action="login_login.action" onsubmit="return checkForm(this)">
				<table>
					<tr>
						<td class="field">用户名：</td>
						<td><input class="text" type="text" name="login_name" onfocus="FocusItem(this)" onblur="CheckItem(this);" /><span></span></td>
					</tr>
					<tr>
